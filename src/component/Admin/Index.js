      ...
      <Grid container spacing={3}>
          ...
          >
              <DialogTitle id="alert-dialog-title">
                  {t('Confirm site URL settings')}
              </DialogTitle>
              <DialogContent>
                  <DialogContentText id="alert-dialog-description">
                      <Typography>
                          {siteURL === "" &&
                              t('You have not set the site URL, do you want to set it to the current ') +
                                  window.location.origin +
                                  " ?"}
                          {siteURL !== "" &&
                              t('The site URL you set is inconsistent with the current URL. Do you want to set it to the current') +
                                  window.location.origin +
                                  " ?"}
                      </Typography>
                      <Typography>
                  ...
                  <List className={classes.root}>
                      ...
                      <ListItem>
                          ...
                          <ListItemText
                              ...
                              secondary={t('Total number of files')}
                          />
                      </ListItem>
                      <ListItem>
                          <ListItemAvatar>
                          ...
                          <ListItemText
                              ...
                              secondary={t('Total number of public shares')}
                          />
                      </ListItem>
                      <ListItem>
                          <ListItemAvatar>
                          ...
                          <ListItemText
                              ...
                              secondary={t('Total number of private shares')}
                          />
                      </ListItem>
                  </List>
              </Paper>
                  ...
                  <div>
                      <List component="nav" aria-label="main mailbox folders">
                          ...
                          >
                              ...
                              <ListItemText primary={t('Discussion community')} />
                              <ListItemIcon className={classes.iconRight}>
                                  <Launch />
                              </ListItemIcon>
                          </ListItem>
                          ...
                          >
                              ...
                              <ListItemText primary={t('Upgrade to Donation Edition')} />
                              <ListItemIcon className={classes.iconRight}>
                                  <Launch />
                              </ListItemIcon>
                          </ListItem>
