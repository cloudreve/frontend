    ...
    return (
      <div>
          <Typography variant={"h6"}>
            {props.policy ? t('Revise') : t('Add to')} {t('Shoot cloud storage strategy again')}
          </Typography>
                      ...
                      <div className={classes.subStepContent}>
                          <Typography variant={"body2"}>
                            ...
                            <Link
                                ...
                                target={"_blank"}
                            >
                              {t('Shoot the cloud panel again')}
                            </Link>
                            {t('Create a cloud storage service.')}
                          </Typography>
                      </div>
                  </div>
                      ...
                      <div className={classes.subStepContent}>
                          ...
                          <div className={classes.form}>
                              <DomainInput
                                  ...
                                  required
                                  label={t('Accelerated Domain Name')}
                              />
                          </div>
                      </div>
                  </div>
                              ...
                              <FormControl required component="fieldset">
                                  ...
                                  >
                                      <FormControlLabel
                                          ...
                                          label={t('Token anti-theft chain is turned on')}
                                      />
                                      <FormControlLabel
                                          value={"false"}
                                          control={
                                          ...
                                          label={t('The Token anti-leech link is not turned on')}
                                      />
                                  </RadioGroup>
                              </FormControl>
                          </div>
                                      ...
                                      onChange={(e) => {
                                          if (
                                              ...
                                              ToggleSnackbar(
                                                  "top",
                                                  "right",
                                                  t('The direct chain function cannot be used after the Token anti-leech link is turned on'),
                                                  "warning"
                                              );
                                              return;
                                          }
