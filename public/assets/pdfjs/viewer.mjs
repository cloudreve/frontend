...
const defaultOptions = {
  ...
  localeProperties: {
    value: {
      lang: pageParams.get("lng") || navigator.language || "en-US",
    },
    kind: OptionKind.BROWSER,
  },
  nimbusDataStr: {
  ...
  standardFontDataUrl: {
    value: "/assets/pdfjs/standard_fonts/",
    kind: OptionKind.API,
  },
  useSystemFonts: {
    value: undefined,
  ...
  workerSrc: {
    value: "/assets/pdfjs/pdf.worker.mjs",
    kind: OptionKind.WORKER,
  },
};
{
  ...
  defaultOptions.sandboxBundleSrc = {
    value: "/assets/pdfjs/pdf.sandbox.mjs",
    kind: OptionKind.VIEWER,
  };
  defaultOptions.viewerCssTheme = {
    value: parseInt(pageParams.get("darkMode")) || 1,
    kind: OptionKind.VIEWER + OptionKind.PREFERENCE,
  };
